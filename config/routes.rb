Rails.application.routes.draw do
  scope :api do
    with_options(defaults: { format: :json }, format: false) do
      ...
      get 'users/:user_id/goods' => 'pons_api#index_good_by_user'
      ...
      post 'works/:id/work_pieces' => 'pons_api#create_work_piece'
      post 'works/:id/work_tags' => 'pons_api#create_work_tag'
      post 'works/:id/work_comments' => 'pons_api#create_work_comment'
      post 'works/:id/goods' => 'pons_api#create_good'
